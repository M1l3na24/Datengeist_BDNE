...
db.ventas_completas.createIndex({ "cliente.segmento": 1 });
db.ventas_completas.createIndex({ "cliente.giro": 1 });
db.ventas_completas.createIndex({ "cliente.id_cliente": 1 });
db.ventas_completas.createIndex({ "clima.temperatura": 1 });
db.ventas_completas.createIndex({ "clima.eventos_festivos_locales": 1 });
